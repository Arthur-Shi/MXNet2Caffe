import sys, argparse
sys.path.append('MXNet2Caffe-master/')
...
parser.add_argument('--mx-model',    type=str, default='model/e2e')
parser.add_argument('--mx-epoch',    type=int, default=1)
parser.add_argument('--cf-prototxt', type=str, default='model/baidian0712/faster_rcnn.prototxt')
parser.add_argument('--cf-model',    type=str, default='/model/train.caffemodel')
